...
and, while we will develop and debug our code using VS Code and it is possible to use Git from VS Code too, typing commands in the command line 'forces' you to familiarise yourself and learn it well.
